...
if exist "%SCRIPT_HOME%\windup-cli-version.txt" set "WINDUP_HOME=%SCRIPT_HOME%"
...
mvn "org.openrewrite.maven:rewrite-maven-plugin:4.13.0:%OR_GOAL%" "-DconfigLocation=%WINDUP_HOME%\rules\openrewrite\rewrite.yml" %OR_CMD_LINE_ARGS%
POPD
